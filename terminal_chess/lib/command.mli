...
val has_move :
  ...
  piecerow ->
  (piece * string) list
(** [has_move] takes in a piece list called [same_side_list]
    ...
    [king] representing the king piece, and 8 piecerow representing
    rooks called [r1], [r2], [r3], [r4], [r5], [r6], [r7], [r8] and it
    returns whether the desired move is valid. *)
